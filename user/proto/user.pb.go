...
type RegisterRequest struct {
	...
	Like      string `protobuf:"bytes,3,opt,name=like,proto3" json:"like,omitempty"`                            // 用户喜好
	RequestId string `protobuf:"bytes,4,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // 幂等请求ID
}
...
func (x *UserInfoResponse) GetCreateAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreateAt
	}
	return nil
...
func (x *UserInfoResponse) GetUpdateAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdateAt
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x69, 0x6b, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x6b, 0x65, 0x12,
	0x1d, 0x0a, 0x0a, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x45,
	...
	0x22, 0xcd, 0x01, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73,
	...
	0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69,
	0x6b, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x69, 0x6b, 0x65, 0x12, 0x37,
	...
	0x6d, 0x70, 0x74, 0x79, 0x1a, 0x16, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x14, 0x5a, 0x12,
	0x74, 0x78, 0x2d, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x73,
...
var file_user_proto_depIdxs = []int32{
	5, // 0: user.UserInfoResponse.create_at:type_name -> google.protobuf.Timestamp
	5, // 1: user.UserInfoResponse.update_at:type_name -> google.protobuf.Timestamp
	0, // 2: user.UserService.Register:input_type -> user.RegisterRequest
	2, // 3: user.UserService.Login:input_type -> user.LoginRequest
	6, // 4: user.UserService.GetUserInfo:input_type -> google.protobuf.Empty
	1, // 5: user.UserService.Register:output_type -> user.RegisterResponse
	3, // 6: user.UserService.Login:output_type -> user.LoginResponse
	4, // 7: user.UserService.GetUserInfo:output_type -> user.UserInfoResponse
